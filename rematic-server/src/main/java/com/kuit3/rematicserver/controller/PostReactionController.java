...
public class PostReactionController {
    ...
    public BaseResponse<String> likePost(@PathVariable("post_id") Long postId, @RequestParam("user_id") Long userId) {
        postReactionService.likePost(postId, userId);
        return new BaseResponse<>("좋아요");
    }

    @PostMapping("/{post_id}/hate")
    public BaseResponse<String> hatePost(@PathVariable("post_id") Long postId, @RequestParam("user_id") Long userId) {
